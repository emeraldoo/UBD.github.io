function Uran238_Cal() {
  ...
  if (Number(u238_end) < 0) {
    alert("Der jetzige Wert des Uran-238 ist negativ, Lösung somit ungültig!");
    return;
  }
...
function Uran235_Cal() {
  ...
  if (Number(u235_end) < 0) {
    alert("Der jetzige Wert des Uran-235 ist negativ, Lösung somit ungültig!");
    return;
  }
  var solution = (-1 / 0.00000000098485) * Math.log(Number(u235_end) / Number(u235_start));
  solution = Formattieren(solution);
